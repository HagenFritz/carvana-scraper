...
def execute_scrape(zipcode):
    ...
    for make in filters["make"]["standard"]:
        ...
        sc.find_and_click("button","normalize-space()","Select All",fxn=True)
        sc.find_and_click("span","normalize-space()","MAKE & MODEL",fxn=True)
        time.sleep(5)
        # setting up results
        results = {
